...
מודול ה-CSV Import מאפשר לנו לייבא Items או משתמשים אל התקנת ה-Omeka S שלנו ישירות מקובץ מסוג csv (comma separated values), tsv (tab separated values) או odf (open document format).
...
__*Map to Omeka S data – מיפוי לדאטה של אומקה*__
...
__*Mapping options – אפשרויות מיפוי*__
...
__*Column options – אפשריות עמודה*__
...
__*Batch edit – עריכה קבוצתית*__
...
__*Item import Basic Settings – הגדרות ייבוא בסיסיות לפריט*__
...
__*Item import Advanced Settings - הגדרות ייבוא מתקדמות לפריט*__
...
__*Other advanced settings – פעולות מתקדמות נוספות*__
...
__*Complete import – ייבוא מלא*__
...
__*Item Set import Basic Settings – הגדרות ייבוא בסיסיות לסט פריטים*__
...
__*Item Set import Advanced Settings - הגדרות ייבוא מתקדמות לסט פריטים*__
...
__*Media import Basic Settings – הגדרות ייבוא בסיסיות למדיה*__
...
__*Media import Advanced Settings - הגדרות ייבוא מתקדמות למדיה*__
...
__*Mapping options  TK- אפשרויות מיפוי*__
...
__*Mixed resources import Basic Settings – הגדרות ייבוא בסיסיות למשאב מעורב*__
...
__*Mixed resources import Advanced Settings - הגדרות ייבוא מתקדמות למשאב מעורב*__
...
__*Map user import to Omeka S data*__
...
__*Undo an Import - ביטול ייבוא*__
